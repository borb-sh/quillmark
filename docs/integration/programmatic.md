...
- **`quill.seed_document()`** is the illustration-first starter: `example:` values committed, one card per declared kind. Hand it to a human or an editor to fill in; see [Blueprint, Seeding & Examples](../quills/blueprint.md).
