...
| `example`     | string | Guide text shown on the blueprint's `# e.g.` line above the body, and an editor may show it as the empty body's placeholder; never seeded. |
