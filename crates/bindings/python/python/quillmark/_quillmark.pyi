...
class Writer:
    ...
    def set(self, name: str, value: Any, card: int | None = None) -> None: ...
    def set_all(self, fields: dict[str, Any], card: int | None = None) -> None: ...
    def set_values(self, values: dict[str, Any], card: int | None = None) -> None: ...
    def revise_body(self, markdown: str, card: int | None = None) -> None: ...
    def revise_field(self, name: str, text: str, card: int | None = None) -> None: ...
    def add_card(
        self,
        kind: str,
...
class Reader:
    ...
    def values(self, card: int | None = None) -> dict[str, Any]: ...
