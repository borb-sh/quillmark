...
impl From<quillmark::ParseError> for CliError {
    fn from(err: quillmark::ParseError) -> Self {
        CliError::Parse(err)
    }
}

impl From<quillmark::BoundParseError> for CliError {
    fn from(err: quillmark::BoundParseError) -> Self {
        use quillmark::BoundParseError as E;
        match err {
...
pub fn print_warnings(warnings: &[quillmark::Diagnostic]) {
