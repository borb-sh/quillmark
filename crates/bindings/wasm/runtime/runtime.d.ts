...
// narrows the payload on its own: `line.kind === 'heading'` reaches
// `line.attrs.level`. These guards name that check for the payload-carrying
// arms; only those get one, since the rest narrow to nothing.
