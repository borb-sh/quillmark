...
//! [`RichText`](quillmark_richtext::RichText) to Typst markup — reusing
//! [`escape_markup`](crate::convert::escape_markup) /
//! [`escape_string`](crate::convert::escape_string), never re-parsing markdown —
//! and records, per segment, the generated byte window plus one `(corpus ↔ gen)`
//! pair per text run.
//!
...
//! scan against [`escape_markup`](crate::convert::escape_markup) /
//! [`escape_string`](crate::convert::escape_string) byte-for-byte, so a future
