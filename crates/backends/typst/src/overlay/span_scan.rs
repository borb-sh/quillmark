...
/// The corpus USV offset a glyph's generated position maps to, plus how
...
/// **segment**'s corpus start — [`HitGranularity::Segment`] — not a node-start
...
fn invert_hit(
    ...
    let Some((corpus_r, gen_r, ctx)) = segmap
        ...
        return (segmap.corpus.start, HitGranularity::Segment);
    };
