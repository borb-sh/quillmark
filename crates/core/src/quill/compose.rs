...
/// Report the input no declaration claims: a card whose `$kind` is undeclared,
/// body prose under `body.enabled: false`, and a key no
...
"#,
        ...
        let doc = Document::from_main_and_cards(main, vec![unknown]);
